...
```{r phylo-tree", echo=FALSE, message=FALSE, warning=FALSE, out.width="80%"}
...
```{r Lefse analysis Results, echo=FALSE, message=FALSE, warning=FALSE, fig.height=25, fig.width=10, out.width="80%"}
