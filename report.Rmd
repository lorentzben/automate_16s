...
```{r phylo-tree", echo=FALSE, message=FALSE, warning=FALSE, out.extra='style="display:block; margin:auto;"', out.width="100%"}
...
if(getOutputFormat() =='pdf_document'){
  tree_filenames <- list.files(pattern="image_.*_pdf_g.png")
  tree_filenames <- mixedsort(tree_filenames)
...
```{r Lefse analysis Results, echo=FALSE, message=FALSE, warning=FALSE, fig.height=25, fig.width=10, out.extra='style="display:block; margin:auto;"', out.width="100%"}
...
if(getOutputFormat() =='pdf_document'){
  lefse_res_filenames <- list.files(pattern="*_pdf_r.png")
  lefse_clado_filenames <- list.files(pattern="*_pdf_qual_clad.png")
