...
w_uni_pear <- data.frame(w_uni_pear)
w_uni_pear <- w_uni_pear[mixedorder(w_uni_pear$group1),]
kable(w_uni_pear) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
uw_uni_pair <- data.frame(uw_uni_pair)
uw_uni_pair <- uw_uni_pair[mixedorder(uw_uni_pair$group1),]
kable(uw_uni_pair) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
bray_pair <- data.frame(bray_pair)
bray_pair <- bray_pair[mixedorder(bray_pair$group1),]
kable(bray_pair) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
jaccard_pair <- data.frame(jaccard_pair)
jaccard_pair <- jaccard_pair[mixedsort(jaccard_pair$group1), ]
kable(jaccard_pair) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
#Jaccard ANOSIM plot
