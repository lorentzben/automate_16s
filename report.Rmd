...
```{r Lefse analysis Results, echo=FALSE, message=FALSE, warning=FALSE, fig.height=25, fig.width=10, fig.pos='h', out.height="100%",fig.align="center"}
...
```{r Lefse analysis Results pdf style, echo=FALSE, message=FALSE, warning=FALSE, out.height="85%",dpi=72, out.width="85%", fig.cap="\\newline{}"}
if(getOutputFormat() =='pdf_document'){
  print("see end of report")
