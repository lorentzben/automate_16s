...
w_uni_pear_df <- w_uni_pear_df[mixedsort(w_uni_pear_df$group1),]
kable(w_uni_pear_df) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
uw_uni_pair_df <- uw_uni_pair_df[mixedsort(uw_uni_pair_df$group1),]
...
bray_pair <- bray_pair_df[mixedsort(bray_pair_df$group1),]
kable(bray_pair_df) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
jaccard_pair_df <- jaccard_pair_df[mixedsort(jaccard_pair_df$group1), ]
