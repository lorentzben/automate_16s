...
cycle_1 <- qza_to_phyloseq("table-dada2.qza","rooted-tree.qza","taxonomy.qza","metadata.tsv")
bray_dist <- read_qza("core-metrics-results/bray_curtis_distance_matrix.qza")
meta <- sample_data(cycle_1)
...
cycle_1 <- qza_to_phyloseq("table-dada2.qza","rooted-tree.qza","taxonomy.qza","metadata.tsv")
jaccard <- read_qza("core-metrics-results/jaccard_distance_matrix.qza")
meta <- sample_data(cycle_1)
...
w_uni <- read_qza("core-metrics-results/weighted_unifrac_distance_matrix.qza")
#Weighted Unifrac
...
un_uni <- read_qza("core-metrics-results/unweighted_unifrac_distance_matrix.qza")
#Unweighted Unifrac
attach(sample_data(cycle_1))
...
bray <- read_qza("core-metrics-results/bray_curtis_distance_matrix.qza")
#Bray Curtis
attach(sample_data(cycle_1))
...
u_uni <- read_qza("core-metrics-results/unweighted_unifrac_distance_matrix.qza")
u_uni <- u_uni$data
# Unweighted Unifrac
