...
```{r Lefse analysis Results, echo=FALSE, message=FALSE, warning=FALSE, fig.height=25, fig.width=10, fig.pos='h', out.height="100%",fig.align="center", fig.cap="\\newline{}"}
...
\begin{center}
```{r Lefse analysis Results pdf style, echo=FALSE, message=FALSE, warning=FALSE, fig.pos='h', out.height="100%", out.width="85%",fig.align="center", fig.cap="\\newline{}"}
if(getOutputFormat() =='pdf_document'){
  print("see end of report")
