...
```{r phylo-tree", echo=FALSE, message=FALSE, warning=FALSE, out.width="100%", out.height="100%"}
...
```{r Lefse analysis Results, echo=FALSE, message=FALSE, warning=FALSE, fig.height=25, fig.width=10, out.height="100%", out.width="100%"}
