...
```{r stacked bar chart at Phylum level, message=FALSE, warning=FALSE, echo=FALSE,  fig.width=18, fig.height=12}
...
```{r stacked bar chart at Genus level, message=FALSE, warning=FALSE, echo=FALSE,  fig.width=18, fig.height=12}
level = "Genus"
...
```{r stacked bar chart at Species level, message=FALSE, warning=FALSE, echo=FALSE,  fig.width=18, fig.height=12}
level = "Species"
...
```{r heatmap at the Genus level annotatted with item of interest, fig.width=18, fig.height=12, echo=FALSE, warning=FALSE, message=FALSE}
