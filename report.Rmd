...
euclidean_frame
ggsave("PCA_euclidain_ordination_whith_boundries.png", plot=euclidean_frame , path=outdir)
euclidean <- amp_ordinate(cycle_1_amp, filter_species = 0, type = "PCA", transform = "hellinger", print_caption = T,sample_color_by = ioi) 
euclidean

ggsave("PCA_euclidain_ordination_whith_boundries.png", plot=euclidean , path=outdir)
```
...
### 12.6 Multi-response permutaiton procedure (MRPP)
