...
test <- test[mixedsort(test$group1),]
kable(test) %>% 
...
bray_pairwise <- data.frame(bray_pairwise)
bray_pairwise <- bray_pairwise[mixedsort(bray_pairwise$group1),]
kable(bray_pairwise) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
...
jaccard_pairwise <- data.frame(jaccard_pairwise)
jaccard_pairwise <- jaccard_pairwise[mixedsort(jaccard_pairwise$group1),]
...
w_uni_pear_df <- data.frame(w_uni_pear)
w_uni_pear_df <- w_uni_pear_df[mixedorder(w_uni_pear_df$group1),]
kable(w_uni_pear_df) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
uw_uni_pair_df <- data.frame(uw_uni_pair)
uw_uni_pair_df <- uw_uni_pair_df[mixedorder(uw_uni_pair_df$group1),]
kable(uw_uni_pair_df) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
bray_pair_df <- data.frame(bray_pair)
bray_pair <- bray_pair_df[mixedorder(bray_pair_df$group1),]
kable(bray_pair_df) %>% 
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
jaccard_pair_df <- data.frame(jaccard_pair)
jaccard_pair_df <- jaccard_pair_df[mixedorder(jaccard_pair_df$group1), ]
kable(jaccard_pair_df) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
#Jaccard ANOSIM plot
...
w_uni_res <- data.frame(w_uni_res)
w_uni_res <- w_uni_res[mixedsort(w_uni_res$group1),]
kable(w_uni_res) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
u_uni_res <- data.frame(u_uni_res)
u_uni_res <- u_uni_res[mixedsort(u_uni_res$group1),]
kable(u_uni_res) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
bray_res <- data.frame(bray_res)
bray_res <- bray_res[mixedsort(bray_res$group1),]
kable(bray_res) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
jaccard_res <- data.frame(jaccard_res)
jaccard_res <- jaccard_res[mixedsort(jaccard_res$desc(group1),]
kable(jaccard_res) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
pairwise_AMOVA_uni <- function(dat, column_of_int, weight){
  ...
  amova_stats <- c(as.numeric(as.character(combos[i,1])), as.numericas.character(combos[i,2]),weight, round(amova_res$tab$MSD[1],6),  round(amova_res$varcomp$P.value[1],3))
...
w_uni_pair <- data.frame(w_uni_pair)
w_uni_pair <- w_uni_pair[mixedsort(w_uni_pair$group1),]
kable(w_uni_pair) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
u_uni_pair <- data.frame(u_uni_pair)
u_uni_pair <- u_uni_pair[mixedsort(u_uni_pair$group1),]
kable(u_uni_pair) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
...
bray_amova_pairwise <- data.frame(bray_amova_pairwise)
bray_amova_pairwise <- bray_amova_pairwise[mixedsort(bray_amova_pairwise$group1),]
...
jaccard_amova_pairwise <- data.frame(jaccard_amova_pairwise)
jaccard_amova_pairwise <- jaccard_amova_pairwise[mixedsort(jaccard_amova_pairwise$group1),]
