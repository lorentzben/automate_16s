...
do
    ...
    plot_cladogram.py lefse_result.res "${eachfile::-4}"_cladogram.png --format png --dpi 100
    ...
    graphlan.py annotated_tree_lefse.txt "${eachfile::-4}"_better_cladogram.png --format png --size 10 --dpi 100
