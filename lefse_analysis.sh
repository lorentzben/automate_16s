...
do
    ...
    plot_res.py lefse_result.res "${eachfile::-4}"res.png --dpi 150 
    ...
    graphlan.py annotated_tree_lefse.txt "${eachfile::-4}"better_cladogram.png --format png --size 16 --dpi 300 --pad 0.2
done
conda deactivate